...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-col border-r-2 border-sidebar-border bg-sidebar text-sidebar-foreground overflow-hidden transition-all duration-500 w-72 sm:w-80", // Use sidebar-border
